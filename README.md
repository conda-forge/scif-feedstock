...
Once the `conda-forge` channel has been enabled, `scif` can be installed with:

```
conda install scif
```

It is possible to list all of the versions of `scif` available on your platform with:
